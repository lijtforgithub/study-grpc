...
public class RouteGuideUtil {
   ...
   */
  public static double getLatitude(RouteGuideProto.Point location) {
   ...
   */
  public static double getLongitude(RouteGuideProto.Point location) {
   ...
   */
  public static List<RouteGuideProto.Feature> parseFeatures(URL file) throws IOException {
    InputStream input = file.openStream();
    try {
      Reader reader = new InputStreamReader(input, Charset.forName("UTF-8"));
      try {
        RouteGuideProto.FeatureDatabase.Builder database = RouteGuideProto.FeatureDatabase.newBuilder();
   ...
   */
  public static boolean exists(RouteGuideProto.Feature feature) {
