...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.ljt.study.grpc.HelloProto.HelloRequest,
      com.ljt.study.grpc.HelloProto.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.ljt.study.grpc.HelloProto.HelloRequest.class,
      responseType = com.ljt.study.grpc.HelloProto.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.ljt.study.grpc.HelloProto.HelloRequest,
      com.ljt.study.grpc.HelloProto.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.ljt.study.grpc.HelloProto.HelloRequest, com.ljt.study.grpc.HelloProto.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.ljt.study.grpc.HelloProto.HelloRequest, com.ljt.study.grpc.HelloProto.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ljt.study.grpc.HelloProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ljt.study.grpc.HelloProto.HelloReply.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.ljt.study.grpc.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.ljt.study.grpc.HelloProto.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.ljt.study.grpc.HelloProto.HelloRequest,
                com.ljt.study.grpc.HelloProto.HelloReply>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.ljt.study.grpc.HelloProto.HelloReply sayHello(com.ljt.study.grpc.HelloProto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ljt.study.grpc.HelloProto.HelloReply> sayHello(
        com.ljt.study.grpc.HelloProto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.ljt.study.grpc.HelloProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.ljt.study.grpc.HelloProto.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ljt.study.grpc.HelloProto.getDescriptor();
    }
